...
# 1. Configuration
# ==========================================
MODEL_PATH = "/mnt/scratch/users/sglli24/fine-tuning-project/fine_tuned_model/llama3.2-1b-sst2-full-20251209-1554/checkpoint-1266/"  # modify this to your model path
